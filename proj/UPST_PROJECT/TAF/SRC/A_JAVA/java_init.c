/**		@file	java_init.c
 * 		- A_JAVA 프로세스를 초기화 하는 함수들
 *
 * 		Copyright (c) 2006~ by Upresto Inc. Korea
 * 		All rights reserved
 *
 * 		 $Id: java_init.c,v 1.2 2011/09/05 04:25:52 uamyd Exp $
 *
 * 		@Author		$Author: uamyd $
 * 		@version	$Revision: 1.2 $
 * 		@date		$Date: 2011/09/05 04:25:52 $
 * 		@ref		java_init.c java_maic.c
 *
 * 		@section	Intro(소개)
 * 		- A_JAVA 프로세스를 초기화 하는 함수들
 *
 ...
 *
 *  @return			S32
 *  @see			java_init.c java_main.c
 *
 **/
S32 dInitJAVA(stMEMSINFO **pMEMSINFO)
{
	/* Setup Signal */
	SetUpSignal();

	if((*pMEMSINFO = nifo_init_zone((U8*)"A_JAVA", SEQ_PROC_A_JAVA, FILE_NIFO_ZONE)) == NULL) {
 ...
 * Commit TAF/SRC
 *
 * Revision 1.3  2011/08/17 07:20:35  dcham
 * *** empty log message ***
 *
 ...
 * init DQMS2
 *
 * Revision 1.4  2011/05/09 15:19:49  jsyoon
 * *** empty log message ***
 *
 * Revision 1.3  2011/01/11 04:09:07  uamyd
 * modified
 *
 * Revision 1.1.1.1  2010/08/23 01:13:02  uamyd
 * DQMS With TOTMON, 2nd-import
 *
 * Revision 1.2  2009/06/29 13:22:25  dark264sh
 * *** empty log message ***
 *
