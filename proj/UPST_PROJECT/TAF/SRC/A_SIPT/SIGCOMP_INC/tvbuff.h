 ...
 * 		other tvbuffs.
 *
 * $Id: tvbuff.h,v 1.1.1.1 2011/08/29 05:56:42 dcham Exp $
 *
...
extern gint tvb_reported_length_remaining(gchar *tvb, gint tlen, gint offset);
...
extern guint8 tvb_get_guint8(gchar *tvb, gint tlen, gint offset);

//extern guint16 tvb_get_ntohs(tvbuff_t*, gint offset);
extern guint16 tvb_get_ntohs(gchar *tvb, gint tlen, gint offset);
...
extern guint8* tvb_memcpy(gchar *tvb, gint tlen, guint8* target, gint offset, gint length);
