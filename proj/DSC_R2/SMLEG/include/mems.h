...
typedef struct _st_memszone {
	 ...
	 *    MEMS_SEMA_OFF      0
	 */
	U32     uiSemFlag;  /**< Semaphore ≫c¿e ¿ⓒºI */
	U32     uiSemKey;           /**< Semaphore Key °ª */
	S32     iSemID;             /**< Semaphore ID °ª */
	U32     uiZoneID;
	U32     uiMemNodeBodySize;  /**< Node¾EAC hdrμU¿¡ ºU´A BodyAC Size :\nAI BodyAC Size°¡ ½CA|·I ¿øCI´A Size°¡ μE °IAO */
	U32     uiMemNodeAllocedCnt;    /**< AI¹I allocμC¾iAø °¹¼o */
	U32     uiMemNodeTotCnt;        /**< AuA¼ ³eμaAC °¹¼o */
	OFFSET  offsetNodeStart;        /**< NodeμeAC A³A½ A§A¡ */
	OFFSET  offsetFreeList;         /**< FreeμE NodeAC A§A¡ */
