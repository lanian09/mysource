...
//#define DEF_ETC_SVCTYPE		99
#define DEF_FBDOMAIN_NORMAL		1
#define DEF_FBDOMAIN_FREE		2
...
typedef struct _st_MsgQ
{
	...
	int			uiReserved;
//	int			uiReserved1;
	USHORT 		usRetransCnt;				/* Retransmission Count */
	USHORT 		usRetransLen;				/* Retransmission Length */
...
#define DEF_STOPKEY_SIZE		sizeof(st_STOPMsgKey)
...
#define SID_SYNC                81	/* Sess Sync Service In DulaActive */

/* Session Clear MID */
#define MID_SESS_CLEAR          101

/* Session Sync MID */
#define MID_SESS_SYNC           102
...
#define SID_LOG_ON				80
#define SID_LOG_OUT				81
#define SID_LOG_OUT_MMC			82
#define SID_ACC_REQ				91
#define SID_ACC_END				92
#define SID_SET_SM_BUF_CLR		100
#define SID_DEL_SM_BUF_CLR		101
#define MID_ACC_START			11
#define MID_ACC_RESPONSE		12
#define MID_ACC_END				13
#define MID_ACC_INTERIM			15

#define MID_INTERIM_CDR2		16	// ADDED BY LYH 07.05.23
...
/* ADDED BY YOON 2009.04.22 */
#define MID_HOLE_REQ			22
#define MID_HOLE_RES			23
 ...
 * DESC: Disconnect_Req 추가.
 */
#define DEF_DISCONNECT_REQ		40
#define MID_DISC_REQ			40

/* ADDED BY YOON 2009.04.22 */
#define DEF_HOLECHECK_REQ		240
#define DEF_HOLECHECK_RES		241
...
/** BSDR1.3.0 20070104 add(kmyang)  **/
#define SID_EVDO                102
#define MID_EVDO_RES            101

/* ADDED BY YOON DSC, 20090424 */
#define	SID_REDIRECT 			103
#define MID_SUBS_INFO 			104

/* RETRANSISSION TYPE, ADDED BY YOON 20090225 */
...
typedef struct _st_AAAFlgInfo
{
	...
	/* R1.3.1 20070104 add(challa) ---> */
	UCHAR   ucAudioInputIPSizeF;        /* AUDIO-UPLOAD-SIZE                (26/238) */
	UCHAR   ucAudioOutputIPSizeF;       /* AUDIO-DOWNLOAD-SIZE              (26/239) */
	UCHAR   ucVideoInputIPSizeF;        /* VIDEO-UPLOAD-SIZE                (26/240) */
	UCHAR   ucVideoOutputIPSizeF;       /* VIDEO-DOWNLOAD-SIZE              (26/241) */
	/* <--- */
	...
	// R218
#if 1
	UCHAR	ucDOATF;					/* 080220, poopee, HBIT, ucC23BITF -> ucDOATF */
...
typedef struct _st_ACCInfo
{
	...
	INT		uiPBIT;						/* 090421, YOON, PBIT */
	INT		uiCBIT;						/* 090421, YOON, CBIT */
	// R218
	UCHAR   szMIN        [MAX_MIN_SIZE];        /* Calling-Station-ID : 15+1        */

} st_RADInfo, *pst_RADInfo;

#define DEF_RADINFO_SIZE		sizeof(st_RADInfo)
...
typedef struct _st_UDRInfo_
{
	...
	char       szPacketCnt[DEF_PKTCNT_SIZE]; /* PACKET COUNT:93	-> 100 			 */
	UCHAR	   ucURLCha;
	UCHAR       ucRSFlag;
	char		szReserved1[6];
...
#define	 MAX_DACT_QUEUE_NUM	500	/* 070612, poopee, DACTIVE */
...
/* 070612, poopee, DACTIVE */
typedef struct _st_DactQueueList {
    short       tail;
    short       head;
    st_Queue    stQueue[MAX_DACT_QUEUE_NUM];
} st_DactQueueList, *pst_DactQueueList;
...
typedef struct _st_IPPool
{
	...
	char		szSysIP[16];
	int			iPrefix;
	char		pdsn_type[16]; // add by helca 080718
...
#define MAX_SERVICE_CATEGORY_COUNT  2000
...
/** BSDR1.3.0 20070104 add(kmyang)  **/
typedef struct _st_Evdo_Res_t
{
    UINT        uiResCode;              /* Response-Code */
	UCHAR		szReserved[20];
} st_Evdo_Res_t, *pst_Evdo_Res_t;
