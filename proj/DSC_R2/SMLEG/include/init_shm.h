...
//MODIFIED BY LYH 2007.04.17
//extern st_RadiusStat_List *radius_stat;
extern st_PDSN_RadiusStat_List *radius_stat;
...
int Init_Cap( int key, int key_buf );
...
int Init_CapBuf( int key );
 
int Init_FBCDR_STAT( int key, int procnum );
int Init_FB_STAT( int key, int procnum );
int Init_ME_STAT( int key, int procnum );
int Init_WV_STAT( int key, int procnum );
int Init_KUN_STAT( int key, int procnum );
int Init_WAP_STAT( int key, int procnum );
int Init_RADIUS_STAT( int key );
...
int Init_MMDBDOMAIN( int key );
int Init_MMDBFREEURL( int key );
int Init_MMDBFBCALL( int key );
int Init_MMDBFBCDR( int key );
int Init_MMDBWVCDR( int key );
int dInitSHMACCMMAB_acc(int dMMDBSHMKey);


int Init_PCDRCDR(int key);
int Init_PCDROBJ(int key);
int Init_PCDRSESS(int key);


int Init_TIMER( int key );
