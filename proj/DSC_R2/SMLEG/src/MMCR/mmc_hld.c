...
{
    {"dis-cps-info", 	mmcr_mmc_dis_cps_info},
    {"dis-sess",		mmcr_mmc_dis_sess},
    {"dis-sess-cnt",	mmcr_mmc_dis_sess_cnt},
    {"dis-sess-list",	mmcr_mmc_dis_sess_list},
    {"stop-delay-check",    cdelay_mmc_stop_delay_check},
	{"dis-tmr-info", 	mmcr_mmc_dis_tmr_info},
	{"set-tmr-info", 	mmcr_mmc_set_tmr_info},
	{"dis-call-trc", 	mmcr_mmc_dis_call_trc},
	{"reg-call-trc", 	mmcr_mmc_reg_call_trc},
	{"canc-call-trc", 	mmcr_mmc_canc_call_trc},
//	{"set-smbuf-clr", 	mmcr_mmc_set_smbuf_clr},
//	{"del-smbuf-clr", 	mmcr_mmc_del_smbuf_clr},
//	{"dis-smbuf-clr", 	mmcr_mmc_dis_smbuf_clr},
    {"sync-rule-file", 	mmcr_mmc_sync_rule_file},
    {"sess-log-out",	mmcr_mmc_sce_log_out},
    {"dis-rule-use",	mmcr_mmc_dis_rule_use},
    {"set-rule-use",	mmcr_mmc_set_rule_use},
    {"del-rule-use",	mmcr_mmc_del_rule_use},
	{"dis-rleg-sess",   mmcr_mmc_dis_rleg_sess},
    {"set-ovld-ctrl",	mmcr_mmc_set_ovld_ctrl},
    {"dis-ovld-ctrl",	mmcr_mmc_dis_ovld_ctrl},
    {"dis-call-info",	mmcr_mmc_dis_call_info}
