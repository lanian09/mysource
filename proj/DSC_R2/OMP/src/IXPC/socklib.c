...
int socklib_sndMsg (int fd, char *buff, int buffLen)
{
	...
	fd_set	wFdSet;
	char	*ptr;
// 0717 jjinri	SockLibHeadType *head;
...
int socklib_setSockOption (int fd)
{
	...
	int		reUseOpt=1;
	int		buffSize;
// 0717 jjinri	int		flag;
	struct linger	lin;
// 0717 jjinri	struct protoent	*proto;
	...
	*/
	buffSize = SOCKLIB_SEG_MAX_BUF_SIZE;
